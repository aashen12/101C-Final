...
# Plot RSS
par(mfrow=c(2,2))
plot(sumBS$rss, xlab = "Number of Variables", ylab = "RSS", type = "l")
# Plot Adjusted R^2, highlight max value
plot(sumBS$adjr2, xlab = "Number of Variables", ylab = "Adjusted RSq", type = "l")
max = which.max(sumBS$adjr2)
points(max, sumBS$adjr2[max], col = "red", cex = 2, pch = 20)
# Plot Cp, highlight min value
plot(sumBS$cp, xlab = "Number of Variables", ylab = "Cp", type = "l")
min = which.min(sumBS$cp)
points(min,sumBS$cp[min], col = "red", cex = 2, pch = 20)
# Plot BIC, highlight min value
plot(sumBS$bic, xlab = "Number of Variables", ylab = "BIC", type = "l")
min = which.min(sumBS$bic)
points(min, sumBS$bic[min], col = "red", cex = 2, pch = 20)
```
...
bs_mod <- lm(growth_2_6 ~ cnn_17 + cnn_89 + punc_num_..28 + 
               Num_Subscribers_Base1 + avg_growth3, data = train)
```


```{r}
predict(bs_mod, newdata = validation)
```
