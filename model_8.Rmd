...
cor_vars <- which(abs(cor_mtx) > 0.75, arr.ind = TRUE)
...
keep_vars <- c(keep_vars[1:103], names(training)[170:173])
```
...
write.csv(test_csv, "model8predictions.csv", row.names = FALSE)
```